...
type SwordIconProps = { styles: string };

const SwordIcon: React.FC<SwordIconProps> = ({ styles }) => {
  return (
    <>
      <svg
        fill="#000000"
